...
export const metadata: Metadata = {
  ...
  description: "Free online spreadsheet editor with Excel compatibility. Create, edit, and share spreadsheets online with real-time collaboration and advanced formatting.",
  keywords: [
    "excel",
    "spreadsheet",
    "online editor",
  ...
  openGraph: {
    ...
    description: "Free online spreadsheet editor with Excel compatibility. Create, edit, and share spreadsheets online.",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="spreadsheet-capabilities" content="formulas,charts,pivot-tables" />
      </head>
