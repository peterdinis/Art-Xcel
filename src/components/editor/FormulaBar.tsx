...
export const FormulaBar = ({ selectedCell, value, onChange }: FormulaBarProps) => {
    return (
        <div className="h-10 border-b flex items-center px-4 gap-2 bg-background/50">
            <div className="w-10 font-mono text-sm font-bold text-muted-foreground flex items-center justify-center border-r">
                {selectedCell || ""}
            </div>
