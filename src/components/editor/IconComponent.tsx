...
export const IconComponent = ({
  ...
  const Icon = (LucideIcons[iconName] as React.FC<{ size: number; color: string; className?: string }>) || LucideIcons.HelpCircle;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onMouseDown={handleDragStart}
      >
        <Icon size={size} color={color} className="shadow-sm pointer-events-none" />
      </div>
    </div>
  );
};