    ...
    return (
        <ContextMenu>
            ...
            <ContextMenuContent className="w-64">
                ...
                <ContextMenuItem onClick={onDeleteRow} className="gap-2 text-destructive focus:text-destructive">
                ...
                <ContextMenuItem onClick={onDeleteColumn} className="gap-2 text-destructive focus:text-destructive">
                    <MinusCircle className="h-4 w-4" />
